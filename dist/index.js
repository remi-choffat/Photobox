(() => {
  ...
  function displayPicture(image) {
    ...
    const template = import_handlebars.default.compile(imageTemplate);
  ...
  function displayCategory(category) {
    ...
    const template = import_handlebars.default.compile(categoryTemplate);
  ...
  var init_ui = __esm({
    "ui.js"() {
      ...
      import_handlebars.default.registerHelper("sort-by-date-desc", function(comments) {
  ...
  function load(link) {
    return __async(this, null, function* () {
      galerie = yield loadResource(link);
      return galerie;
    });
  }
  var galerie;
  ...
  function display_gallery() {
    return __async(this, arguments, function* (link = PHOTOBOX_URL) {
      ...
      previous.addEventListener("click", function() {
        ...
        if (link2) {
          display_gallery(link2);
        }
      });
      next.addEventListener("click", function() {
        const link2 = next.dataset.liengalerie;
        if (link2) {
          display_gallery(link2);
        }
      });
  ...
  var import_handlebars2;
  var init_gallery_ui = __esm({
    "gallery_ui.js"() {
  ...
  // index.js
  var require_TP6 = __commonJS({
    "index.js"(exports) {
      init_photoloader();
      init_ui();
      init_gallery_ui();
      (() => __async(exports, null, function* () {
        console.info("R\xE9mi Choffat - TP Photobox");
        ...
        function getCategorie(photo2) {
          return loadResource(photo2.links.categorie.href);
        }
        function getComments(photo2) {
          return loadResource(photo2.links.comments.href);
        }
      }))();
    }
  });
